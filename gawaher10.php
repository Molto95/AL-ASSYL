...
<body class="index-page">
  ...
  <main class="main">
    ...
    <div id="careers-cover" class="careers-cover section_w_padding">
      <img src="assets/img/PASTA/Ranges-Gawaher10Kg.png" class="custom-image" style="height: 600px;">
      </div>  
    <!-- /Hero Section -->
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="testimonial-item">
                ...
                <p style="line-height: 30px;">
                  <span>It's the ideal pasta brand for the family as it focuses on offering guaranteed quality, golden color, and superior taste, providing varieties and convenience for mainstream pasta consumers.</span>
                </p>
              </div>
      ...
      <div class="container">
          <div class="row">
            ...
            <div class="col-md-12 centered-content">
              <img src="assets/img/PASTA/Gawaher-10kg.png" style="width:150px; height: 200px;" alt="Gawaher 10Kg">
              ...
              <table class="table table-bordered">
                <tbody>
                  ...
                  <td>
                    ...
                    <td>
                      <img style="width:50px;height:50px;" src="assets/img/PASTA/Spaghetti.png" alt="Logo 7">
                      <h6 class="main-title">Spaghetti</h6>
                    </td>
                    <td>
                      <img style="width:50px;height:50px;" src="assets/img/PASTA/Fusili.png"  alt="Logo 8">
